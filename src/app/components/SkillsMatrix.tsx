...
const SKILL_CATEGORIES = [
  {
    ...
    color: "#00e5ff",
    icon: "◈",
    skills: ["SQL", "NoSQL", "PostgreSQL", "Relational Databases", "Database Design", "DBMS", "Data Analysis", "Databases"],
  },
  {
    label: "LANGUAGES & TOOLS",
    color: "#00ff9f",
    icon: "◈",
    skills: ["Python", "Pandas", "Web Development"],
  },
  {
    label: "ALGORITHMS & CS",
    color: "#ff2d78",
    icon: "◈",
    skills: ["Algorithms", "Algorithm Analysis", "Algorithm Design", "Data Structures"],
  },
  {
    label: "AI & MACHINE LEARNING",
    color: "#b44fff",
    icon: "◈",
    skills: ["Large Language Models (LLM)", "Machine Learning", "RAG"],
  },
  {
